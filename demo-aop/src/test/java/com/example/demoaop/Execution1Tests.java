...
@SpringBootTest(classes = {MyServiceImpl.class, Execution1Tests.AspectConfig.class})
class Execution1Tests {
    ...
    public static class AspectConfig {
        ...
        @Pointcut("execution(public void com.example.demoaop.service.MyServiceImpl..*(..))")
